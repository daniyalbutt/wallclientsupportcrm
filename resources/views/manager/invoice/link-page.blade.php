                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="invoice" role="tabpanel" aria-labelledby="invoice-tab">
                        <div class="d-sm-flex mb-5" data-view="print">
                            ...
                            <a style="font-family: inherit;" href="{{ route('manager.invoice.pdf', ['invoice' => $_getInvoiceData->id]) }}"
                               class="btn btn-warning mb-sm-0 mb-3 text-uppercase text-dark text-center mx-1 border">
                                <i class="fa-solid fa-file-pdf"></i> Generate PDF </a>
