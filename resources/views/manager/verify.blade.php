                ...
                <div class="col-md-8">
                    <div class="card o-hidden">
                        <div class="p-5">
                            ...
                            <h1 class="mb-3 text-18" style="line-height: 35px;">Verification Code has been send to Email Addresses: <br><a href=""><span style="color: #0C9FC1"></span></a><br><a href=""><span style="color: #0C9FC1"></span></a><br><a href=""><span style="color: #0C9FC1"></span></a></h1>
                            <h2 class="mb-3 text-16" style="line-height: 10px;">Contact# </h2>
