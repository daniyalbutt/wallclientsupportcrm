                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @elseif($datas->form_checker == 1)
                                    <a href="{{ route('admin.form', ['form_id' => $datas->form_id, 'check' => $datas->form_checker, 'id' => $datas->id]) }}" class="btn btn-secondary btn-sm">Logo Form</a>
                                    @elseif($datas->form_checker == 2)
                                    <a href="{{ route('admin.form', ['form_id' => $datas->form_id, 'check' => $datas->form_checker, 'id' => $datas->id]) }}" class="btn btn-secondary btn-sm">Website Form</a>
                                    @elseif($datas->form_checker == 3)
                                    <a href="{{ route('admin.form', ['form_id' => $datas->form_id, 'check' => $datas->form_checker, 'id' => $datas->id]) }}" class="btn btn-secondary btn-sm">SMM Form</a>
                                    @elseif($datas->form_checker == 4)
                                    <a href="{{ route('admin.form', ['form_id' => $datas->form_id, 'check' => $datas->form_checker, 'id' => $datas->id]) }}" class="btn btn-secondary btn-sm">Content Form</a>
                                    @elseif($datas->form_checker == 5)
                                    <a href="{{ route('admin.form', ['form_id' => $datas->form_id, 'check' => $datas->form_checker, 'id' => $datas->id]) }}" class="btn btn-secondary btn-sm">SEO Form</a>
                                    @elseif($datas->form_checker == 6)
                                    <a href="{{ route('admin.form', ['form_id' => $datas->form_id, 'check' => $datas->form_checker, 'id' => $datas->id]) }}" class="btn btn-secondary btn-sm">Book Formatting & Publishing</a>
                                    @elseif($datas->form_checker == 7)
                                    <a href="{{ route('admin.form', ['form_id' => $datas->form_id, 'check' => $datas->form_checker, 'id' => $datas->id]) }}" class="btn btn-secondary btn-sm">Book Writing</a>
                                    @elseif($datas->form_checker == 8)
                                    <a href="{{ route('admin.form', ['form_id' => $datas->form_id, 'check' => $datas->form_checker, 'id' => $datas->id]) }}" class="btn btn-secondary btn-sm">Author Website</a>
                                    @elseif($datas->form_checker == 9)
                                    <a href="{{ route('admin.form', ['form_id' => $datas->form_id, 'check' => $datas->form_checker, 'id' => $datas->id]) }}" class="btn btn-secondary btn-sm">Editing & Proofreading</a>
                                    @elseif($datas->form_checker == 10)
                                    <a href="{{ route('admin.form', ['form_id' => $datas->form_id, 'check' => $datas->form_checker, 'id' => $datas->id]) }}" class="btn btn-secondary btn-sm">Book Cover Design</a>
                                    @endif
                                </td>
                                <td>
