                ...
                <form class="form" action="{{route('admin.merchant.store')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-body">
                        <div class="row">
                            ...
                            <div class="col-md-12 form-group mb-3">                                
                                <label for="public_key">Public Key/AppID <span>*</span></label>
                            ...
                            <div class="col-md-12 form-group mb-3">
                                <label for="secret_key">Secret Key/Access Token <span>*</span></label>
                            ...
                            <div class="col-md-12 form-group mb-3">
                                <label for="secret_key">Login ID/LocationID <span>(If Authorize.net Payment or SquareUp Payment)</span></label>
                            ...
                            <div class="col-md-12 form-group mb-3">
                                ...
                                <select name="is_authorized" id="is_authorized" class="form-control" >
                                    ...
                                    <option value="3">NMI</option>
                                    <option value="4">SquareUP</option>
                                </select>
                            </div>
                            <div class="col-md-12 form-group mb-3">
