                ...
                <div class="tab-content pr-0 pl-0" id="myTabContent">
                    ...
                    <div class="tab-pane fade {{ $count == 0 ? 'show active' : '' }}" id="form-brief-{{$forms->invoice->invoice_number}}-{{$key}}" role="tabpanel" aria-labelledby="form-brief-tab-{{$forms->invoice->invoice_number}}-{{$key}}">
                        ...
                        <form class="col-md-12 brief-form p-0" method="post" action="{{ route('client.logo.form.update', $forms->id) }}" enctype="multipart/form-data">
                            ...
                            <div class="card mb-4">
                                <div class="card-body">
                                    <div class="card-title mb-3">Attachment <small class="text-danger">(All types of images including PDF, DOCx, CSV, TXT & SVG files are allowed).</small></div>
                                    <div class="row">
                                        <div class="col-12">
                                            <input type="file" accept="image/*,.pdf,.docx,.csv,.txt,.svg" name="attachment[]" multiple/>
                                        </div>
                                                ...
                                                @endphp
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="file-box">
                                                            ...
                                                            <a href="javascript:;" data-id="{{ $formfiles->id }}" data-code="1" class="btn btn-danger delete-file">Delete</a>
                                                        </div>
                                                    </div>
                                                ...
                                                @endphp
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="file-box">
                                                            ...
                                                            <a href="javascript:;" data-id="{{ $formfiles->id }}" data-code="2" class="btn btn-danger delete-file">Delete</a>
                                                        </div>
                                                    </div>
                                                ...
                                                @endphp
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="file-box">
                                                            ...
                                                            <a href="javascript:;" data-id="{{ $formfiles->id }}" data-code="3" class="btn btn-danger delete-file">Delete</a>
                                                        </div>
                                                    </div>
                                                ...
                                                @endphp
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="file-box">
                                                            ...
                                                            <a href="javascript:;" data-id="{{ $formfiles->id }}" data-code="4" class="btn btn-danger delete-file">Delete</a>
                                                        </div>
                                                    </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 form-group mb-3">
                                            ...
                                            <input class="form-control" name="business_established" id="business_established" type="text" value="{{ old('business_established', $forms->business_established) }}" required/>
                                        </div>
                                        <div class="col-md-3 form-group mb-3">
                                            <label for="original_owner">Mailing Address (for verification purposes) </label>
                                            <input class="form-control" name="original_owner" id="original_owner" type="email"  value="{{ old('original_owner', $forms->original_owner) }}" required/>
                                        </div>
                                        <div class="col-md-3 form-group mb-3">
                                            <label for="age_current_site">Business City </label>
                                            <input class="form-control" name="age_current_site" id="age_current_site" type="text"  value="{{ old('age_current_site', $forms->age_current_site) }}" required/>
                                        </div>
                                        <div class="col-md-3 form-group mb-3">
                                            <label for="top_goals">Business State</label>
                                            <input class="form-control" name="top_goals" id="top_goals" type="text"  value="{{ old('top_goals', $forms->top_goals) }}" required/>
                                        </div>
                                        <div class="col-md-3 form-group mb-3">
                                            <label for="core_offer">Business Zip Code</label>
                                            <input class="form-control" name="core_offer" id="core_offer" type="text"  value="{{ old('core_offer', $forms->core_offer) }}" required/>
                                        </div>
                                        <div class="col-md-3 form-group mb-3">
                                            <label for="average_order_value">Business Phone Number</label>
                                            <input class="form-control" name="average_order_value" id="average_order_value" type="text"  value="{{ old('average_order_value', $forms->average_order_value) }}" required/>
                                        </div>
                                        <div class="col-md-3 form-group mb-3">
                                            <label for="selling_per_month">Business Contact Person Name</label>
                                            <input class="form-control" name="selling_per_month" id="selling_per_month" type="text"  value="{{ old('selling_per_month', $forms->selling_per_month) }}" required/>
                                        </div>
                                        <div class="col-md-3 form-group mb-3">
                                            <label for="client_lifetime_value">Business Contact Person Email Address</label>
                                            <input class="form-control" name="client_lifetime_value" id="client_lifetime_value" type="text"  value="{{ old('client_lifetime_value', $forms->client_lifetime_value) }}" required/>
                                        </div>
                                        <div class="col-md-3 form-group mb-3">
                                            <label for="supplementary_offers">Business Website Address (URL)</label>
                                            <input class="form-control" name="supplementary_offers" id="supplementary_offers" type="text"  value="{{ old('supplementary_offers', $forms->supplementary_offers) }}" required/>
                                        </div>
                                        <div class="col-md-3 form-group mb-3">
                                            <label for="getting_clients">Business Working Hours</label>
                                            <input class="form-control" name="getting_clients" id="getting_clients" type="text"  value="{{ old('getting_clients', $forms->getting_clients) }}" required/>
                                        </div>
                                        <div class="col-md-3 form-group mb-3">
                                            <label for="currently_spending">Business Category </label>
                                            <input class="form-control" name="currently_spending" id="currently_spending" type="text"  value="{{ old('currently_spending', $forms->currently_spending) }}" required/>
                                        </div>
                                        <!--BUSINESS DETAILS END-->
                                        
                                        <div class="col-md-12 form-group mb-3">
                                            <label for="monthly_visitors">Please share your URLs (If any) I don’t have any.</label>
                                            <textarea class="form-control" name="monthly_visitors" id="monthly_visitors" rows="3" required>{{ old('monthly_visitors', $forms->monthly_visitors) }}</textarea>
                                        </div>
                                        <div class="col-md-12 form-group mb-3">
                                            <label for="people_adding">Do you have a physical location for your business? (Yes/No)</label>
                                            <input class="form-control" name="people_adding" id="people_adding" type="text"  value="{{ old('people_adding', $forms->people_adding) }}" required/>
                                        </div>
                                        <div class="col-md-12 form-group mb-3">
                                            <label for="monthly_financial">Which location(s) do you want to target?</label>
                                            <textarea class="form-control" name="monthly_financial" id="monthly_financial" rows="3" required>{{ old('monthly_financial', $forms->monthly_financial) }}</textarea>
                                        </div>
                                        <div class="col-md-12 form-group mb-3">
                                            <label for="that_much">Do you use only one website for this business? If not, list out the others</label>
                                            <textarea class="form-control" name="that_much" id="that_much" rows="3" required>{{ old('that_much', $forms->that_much) }}</textarea>
                                        </div>
                                        <div class="col-md-12 form-group mb-3">
                                            <label for="specific_target">Do you have the ability to make changes by yourself to your website? (Yes/No)</label>
                                            <textarea class="form-control" name="specific_target" id="specific_target" rows="3" required>{{ old('specific_target', $forms->specific_target) }}</textarea>
                                        </div>
                                        <div class="col-md-12 form-group mb-3">
                                            <label for="competitors">Do you currently have access to your Google My Business page? (Yes/No)</label>
                                            <textarea class="form-control" name="competitors" id="competitors" rows="3" required>{{ old('competitors', $forms->competitors) }}</textarea>
                                        </div>
                                        <div class="col-md-12 form-group mb-3">
                                            ...
                                            <textarea class="form-control" name="third_party_marketing" id="third_party_marketing" rows="3" required>{{ old('third_party_marketing', $forms->third_party_marketing) }}</textarea>
                                        </div>
                                        <div class="col-md-12 form-group mb-3">
                                            ...
                                            <textarea class="form-control" name="current_monthly_sales" id="current_monthly_sales" rows="3" required>{{ old('current_monthly_sales', $forms->current_monthly_sales) }}</textarea>
                                        </div>
                                        <div class="col-md-12 form-group mb-3">
                                            <label for="current_monthly_revenue">Which review websites does your business have most reviews on?</label>
                                            <textarea class="form-control" name="current_monthly_revenue" id="current_monthly_revenue" rows="3" required>{{ old('current_monthly_revenue', $forms->current_monthly_revenue) }}</textarea>
                                        </div>
                                        <div class="col-md-12 form-group mb-3">
                                            <label for="target_region">Are there any keyword suggestions? Please list below!</label>
                                            <textarea class="form-control" name="target_region" id="target_region" rows="3" required>{{ old('target_region', $forms->target_region) }}</textarea>
                                        </div>
                                        <div class="col-md-12 form-group mb-3">
                                            ...
                                            <textarea class="form-control" name="looking_to_execute" id="looking_to_execute" rows="3" required>{{ old('looking_to_execute', $forms->looking_to_execute) }}</textarea>
                                        </div>
                                        <div class="col-md-12 form-group mb-3">
                                        ...
                                        <div class="col-md-12 form-group mb-3">
                                            ...
                                            <textarea class="form-control" name="time_zone" id="time_zone" rows="3" required>{{ old('time_zone', $forms->time_zone) }}</textarea>
                                        </div>
                                        <div class="col-md-12 form-group mb-3">
                                            <h4>Content:</h4>
                                        </div>
                                        <div class="col-md-12 form-group mb-3">
                                            ...
                                            <textarea class="form-control" name="seo_content" id="seo_content" rows="3" required>{{ old('seo_content', $forms->seo_content) }}</textarea>
                                        </div>
                                        <div class="col-md-12 form-group mb-3">
                                            <h4>Websites:</h4>
                                        </div>
                                        <div class="col-md-12 form-group mb-3">
                                            ...
                                            <textarea class="form-control" name="inform_websites" id="inform_websites" rows="3" required>{{ old('inform_websites', $forms->inform_websites) }}</textarea>
                                        </div>
                                        <div class="col-md-12 form-group mb-3">
                                        ...
                                        <div class="col-md-12 form-group mb-3">
                                            ...
                                            <textarea class="form-control" name="things_to_avoid" id="things_to_avoid" rows="3" required>{{ old('things_to_avoid', $forms->things_to_avoid) }}</textarea>
                                        </div>
                                        <div class="col-md-12 form-group mb-3">
                                            ...
                                            <textarea class="form-control" name="new_information" id="new_information" rows="3" required>{{ old('new_information', $forms->new_information) }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                                ...
                                                @endphp
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="file-box">
                                                            ...
                                                            <a href="javascript:;" data-id="{{ $formfiles->id }}" data-code="5" class="btn btn-danger delete-file">Delete</a>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 form-group mb-3">
                                         ...
                                         <div class="col-md-6 form-group mb-3">
                                            ...
                                            <input class="form-control" name="keywords" id="keywords" type="text"  value="{{ old('keywords', $forms->keywords) }}" required/>
                                        </div>
                                        <div class="col-md-6 form-group mb-3">
                                            <label for="book_category">Book Category(s)<span>*</span></label>
                                            <input class="form-control" name="book_category" id="book_category" type="text"  value="{{ old('book_category', $forms->book_category) }}" required/>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                                ...
                                                <label for="black_white" class="w-100"> 
                                                    <div class="formCheck purpose-box font-box">
                                                        <div class="form-check ml-0 pl-0">
                                                            <input type="radio" class="form-check-input" id="black_white" name="book_color_type" value="1" data-value="Book Color Type" data-name="required" {{ $forms->book_color_type == '1' ? 'checked' : '' }} >Black & White 
                                                        </div>
                                                    </div>
                                                </label>
                                            </div>
                                            <div class="col-lg-2 form-group mb-3">
                                                <label for="standard_color" class="w-100"> 
                                                    <div class="formCheck purpose-box font-box">
                                                        <div class="form-check ml-0 pl-0">
                                                            <input type="radio" class="form-check-input" id="standard_color" name="book_color_type" value="2" data-value="Book Color Type" data-name="required" {{ $forms->book_color_type == '2' ? 'checked' : '' }} >Standard Color 
                                                        </div>
                                                    </div>
                                                </label>
                                            </div>
                                            <div class="col-lg-2 form-group mb-3">
                                                <label for="premium_color" class="w-100"> 
                                                    <div class="formCheck purpose-box font-box">
                                                        <div class="form-check ml-0 pl-0">
                                                            <input type="radio" class="form-check-input" id="premium_color" name="book_color_type" value="3" data-value="Book Color Type" data-name="required" {{ $forms->book_color_type == '3' ? 'checked' : '' }} >Premium Color
                                                        </div>
                                                    </div>
                                                </label>
                                            </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-3">
                                            <div class="formCheck font-box">
                                                <div class="form-check pl-0">
                                                    <input type="radio" class="form-check-input" id="trim_size_1" name="trim_size" value="5.5_8.5_landscape" {{ $forms->trim_size == '5.5_8.5_landscape' ? 'checked' : '' }}>
                                        ...
                                        <div class="col-lg-3">
                                            <div class="formCheck font-box">
                                                <div class="form-check pl-0">
                                                    <input type="radio" class="form-check-input" id="trim_size_2" name="trim_size" value="5.5_8.5_portrait" {{ $forms->trim_size == '5.5_8.5_portrait' ? 'checked' : '' }}>
                                        ...
                                        <div class="col-lg-3">
                                            <div class="formCheck font-box">
                                                <div class="form-check pl-0">
                                                    <input type="radio" class="form-check-input" id="trim_size_3" name="trim_size" value="6_9_landscape" {{ $forms->trim_size == '6_9_landscape' ? 'checked' : '' }}>
                                        ...
                                        <div class="col-lg-3">
                                            <div class="formCheck font-box">
                                                <div class="form-check pl-0">
                                                    <input type="radio" class="form-check-input" id="trim_size_4" name="trim_size" value="6_9_portrait" {{ $forms->trim_size == '6_9_portrait' ? 'checked' : '' }}>
                                        ...
                                        <div class="col-lg-3">
                                            <div class="formCheck font-box">
                                                <div class="form-check pl-0">
                                                    <input type="radio" class="form-check-input" id="trim_size_5" name="trim_size" value="8.5_11_landscape" {{ $forms->trim_size == '8.5_11_landscape' ? 'checked' : '' }}>
                                        ...
                                        <div class="col-lg-3">
                                            <div class="formCheck font-box">
                                                <div class="form-check pl-0">
                                                    <input type="radio" class="form-check-input" id="trim_size_6" name="trim_size" value="8.5_11_portrait" {{ $forms->trim_size == '8.5_11_portrait' ? 'checked' : '' }}>
                                        ...
                                        <div class="col-lg-3">
                                            <div class="formCheck font-box">
                                                <div class="form-check pl-0">
                                                    <input type="radio" class="form-check-input" id="trim_size_7" name="trim_size" value="Other" {{ $forms->trim_size == 'Other' ? 'checked' : '' }}>
                                        ...
                                        <div class="col-lg-12 form-group mb-3">
                                            ...
                                            <input class="form-control" name="other_trim_size" id="trim_size_8" type="text"  value="{{ old('other_trim_size', $forms->other_trim_size) }}"/>
                                        </div>
                                        <div class="col-md-12 form-group mb-3">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-2">
                                            ...
                                            <div id="ebookPrice" style="display: none;">
                                                ...
                                                <input type="text" class="form-control" id="ebookPriceInput" name="ebook_price" value="{{ $forms->ebook_price !=  null ? $forms->ebook_price : '' }}">
                                            </div>
                                        </div>
                                        <div class="col-lg-2">
                                            ...
                                            <div id="paperbackPrice" style="display: none;">
                                                ...
                                                <input type="text" class="form-control" id="paperbackPriceInput" name="paperback_price" value="{{ $forms->paperback_price !=  null ? $forms->paperback_price : '' }}">
                                            </div>
                                        </div>
                                        <div class="col-lg-2">
                                            ...
                                            <div id="hardcoverPrice" style="display: none;">
                                                ...
                                                <input type="text" class="form-control" id="hardcoverPriceInput" name="hardcover_price" value="{{ $forms->hardcover_price !=  null ? $forms->hardcover_price : '' }}">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12 form-group mb-3">
                                            ...
                                            <input class="form-control" name="other_publish_your_book" id="other_publish_your_book" type="text"   value="{{ $forms->other_publish_your_book !=  null ? $forms->other_publish_your_book : '' }}"/>
                                        </div>
                                    </div>
                                                ...
                                                @endphp
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="file-box">
                                                            ...
                                                            <a href="javascript:;" data-id="{{ $formfiles->id }}" data-code="6" class="btn btn-danger delete-file">Delete</a>
                                                        </div>
                                                    </div>
                                                ...
                                                @endphp
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="file-box">
                                                            ...
                                                            <a href="javascript:;" data-id="{{ $formfiles->id }}" data-code="7" class="btn btn-danger delete-file">Delete</a>
                                                        </div>
                                                    </div>
                                                ...
                                                @endphp
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="file-box">
                                                            ...
                                                            <a href="javascript:;" data-id="{{ $formfiles->id }}" data-code="8" class="btn btn-danger delete-file">Delete</a>
                                                        </div>
                                                    </div>
                                                ...
                                                @endphp
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="file-box">
                                                            ...
                                                            <a href="javascript:;" data-id="{{ $formfiles->id }}" data-code="9" class="btn btn-danger delete-file">Delete</a>
                                                        </div>
                                                    </div>
                                                ...
                                                @endphp
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="file-box">
                                                            ...
                                                            <a href="javascript:;" data-id="{{ $formfiles->id }}" data-code="10" class="btn btn-danger delete-file">Delete</a>
                                                        </div>
                                                    </div>
...
<script>
    ...
    $(".submit-button").click(function(e){
        var $fileUpload = $(this).closest('form').find("input[type='file']");
        if (parseInt($fileUpload.get(0).files.length) > 20){
            toastr.error('You can only upload a maximum of 20 files', '', {timeOut: 5000});
            e.preventDefault();
            $(this).prop('disabled', false); // Enable the button that was clicked
        } else {
            $(this).prop('disabled', true); // Disable the button that was clicked
