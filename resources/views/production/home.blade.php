    ...
    <div class="col-lg-6 col-md-12">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="card card-icon mb-4">
                    <div class="card-body text-center"><i class="i-Data-Backup"></i>
                        <a href="https://projectwall.net/production/home?status%5B%5D=1&category=0">
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="card card-icon mb-4">
                    <div class="card-body text-center"><i class="i-Data-Upload"></i>
                        <a href="https://projectwall.net/production/home?status%5B%5D=4&category=0">
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="card card-icon mb-4">
                    <div class="card-body text-center"><i class="i-Data-Yes"></i>
                        <a href="https://projectwall.net/production/home?status%5B%5D=3&category=0">
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="card card-icon mb-4">
                    <div class="card-body text-center"><i class="i-Data-Block"></i>
                        <a href="https://projectwall.net/production/home?status%5B%5D=2&category=0">
