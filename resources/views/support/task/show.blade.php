                        ...
                        <div class="col-md-7">
                            ...
                            <div class="card">
                                <div class="card-body pl-0 pr-0">
                                    <h4 class="card-title mb-3" style="margin: 0 1.25em;">Files <button class="btn btn-dark btn-sm" id="downloadButton" style="float: right;" type="button">Generate ZIP</button></h4>
                                                ...
                                                @foreach($img_arr as $key => $presignedUrl)
                                                    @if($client_files->id == $key)
                                                        <tr>
                                                            ...
                                                            @endphp
                                                            <td>
                                                                <input type="checkbox" name="files[]" value="{{ $presignedUrl }}">
                                                            </td>
                                                            <td>{{$client_files->id}}</td>
                                                            <td>
                                                                @if(($extension == 'jpg') || ($extension == 'png') || ($extension == 'jpeg') || ($extension == 'webp'))
                                                                    <a id="all-images" href="#show_image_popup">
                                                                        <img class="small-image" src="{{ $presignedUrl }}" alt="{{ $fileName }}.{{$extension}}" width="100">
                                                                    </a>
                                                                @else
                                                            ...
                                                            <td>
                                                                <div class="btn-group float-md-right ml-1">
                                                                    ...
                                                                    <div class="dropdown-menu arrow">
                                                                        <a class="dropdown-item" href="{{ $presignedUrl }}" target="_blank"> View</a>
                                                                        <a class="dropdown-item" href="{{ $presignedUrl }}" download> Download</a>
                                                ...
                                                <div class="ul-widget3-item mt-0 mb-0">
                                                    ...
                                                    <div class="file-wrapper">
                                                        ...
                                                        @foreach($message->sended_client_files as $key => $client_file)
                                                            @foreach($msg_img_arr as $key => $presignedUrl)
                                                                    @if($client_file->id == $key)
                                                                        <ul>
                                                                            <li>
                                                                            ...
                                                                            <li>
                                                                                ...
                                                                                <a href="{{ $presignedUrl }}" target="_blank">
                                                                                    <img src="{{ $presignedUrl }}" alt="{{$client_file->name}}" width="40">
                                                                                </a>
                                                                                @else
                                                                                <a href="{{ $presignedUrl }}" target="_blank">
                                                                            ...
                                                                            <li>
                                                                                <a href="{{ $presignedUrl }}" target="_blank">{{$client_file->name}}</a>
                                                                            </li>
                                                                            <li>
...
function deleteFile(id){
    $.ajax({
        type: "POST",
        url: "{{ route('delete.files.support') }}",
        data: {id:id},
        success: function(response) {
